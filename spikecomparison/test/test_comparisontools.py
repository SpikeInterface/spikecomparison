...
def test_make_possible_match():
    ...
    possible_match_12, possible_match_21 = make_possible_match(sorting1, sorting2, agreement_scores, min_accuracy)
...
def test_make_best_match():
    ...
    best_match_12, best_match_21 = make_best_match(sorting1, sorting2, agreement_scores, min_accuracy)
